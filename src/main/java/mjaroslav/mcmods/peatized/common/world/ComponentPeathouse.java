...
public class ComponentPeathouse extends StructureVillagePieces.Village {
    ...
    public boolean addComponentParts(World world, Random rand, StructureBoundingBox box) {
        ...
        this.generateStructureChestContents(world, box, rand, 6, 1, 4, PeatizedWorld.peathouseChestHook.getItems(rand),
                PeatizedWorld.peathouseChestHook.getCount(rand));
    ...
    protected int getVillagerType(int type) {
        return CategoryGeneralInfo.villagerId;
    }
}
