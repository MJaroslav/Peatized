...
public class CompressorRecipes {
    ...
    private static JSONReader<CompressorRecipeJSON[]> reader = new JSONReader<CompressorRecipeJSON[]>(
            ...
            new File(ModPeatized.configFolder + "/" + ModInfo.MODID + "_compressor_recipes.json"), true);
    ...
    public static void readFromConfig() {
        reader.setFile(new File(ModPeatized.configFolder + "/" + ModInfo.MODID + "_compressor_recipes.json"));
        setNewDefaults();
        reader.init();
