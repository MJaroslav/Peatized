...
public class WailaBogDirtHandler implements IWailaDataProvider {
    ...
    public List<String> getWailaBody(ItemStack itemStack, List<String> currenttip, IWailaDataAccessor accessor,
        ...
        if (!block.isGenerated()) {
            ...
            String waterCountString = (waterCount >= reqWaterMax ? EnumChatFormatting.GREEN : EnumChatFormatting.YELLOW)
                    + String.valueOf(waterCount) + EnumChatFormatting.RESET;
            ...
            int rainBonus = accessor.getWorld().canLightningStrikeAt(accessor.getPosition().blockX,
                    accessor.getPosition().blockY + 1, accessor.getPosition().blockZ) ? rainSummand * -1 : 0;
            ...
            int biomeBonus = ((accessor.getWorld()
                    ...
                    * biomeSummand
                    + (accessor.getWorld()
                            ...
                            .getTempCategory().equals(TempCategory.WARM) ? -1 : 0) * biomeSummand)
                    * -1;
