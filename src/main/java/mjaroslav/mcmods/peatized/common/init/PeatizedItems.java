...
import mjaroslav.mcmods.peatized.common.utils.ColorUtils;
...
public class PeatizedItems implements IInitBase {
	...
	public static Item cleaverPink = new ItemCleaver(ToolMaterial.IRON, ColorUtils.getColorInt("FFAEDC"))
			.setTextureName("minecraft:dye_powder_pink").setUnlocalizedName("peatized.cleaver.pink");
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		GameRegistry.registerItem(cleaverPink, "cleaver_pink");
