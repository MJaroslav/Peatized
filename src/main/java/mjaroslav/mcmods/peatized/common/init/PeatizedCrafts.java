...
public class PeatizedCrafts implements IModModule {
	...
	public void postInit(FMLPostInitializationEvent event) {
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(PeatizedBlocks.compressor, 1, 0), "CPC", "CHC", "COC", 'C',
				"cobblestone", 'P', Blocks.piston, 'H', Blocks.hopper, 'O', Blocks.obsidian));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(PeatizedItems.resource, 1, 3), " C ", "CSC", " C ", 'C',
				"cobblestone", 'S', "stone"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(PeatizedBlocks.compressor, 1, 1), "CHC", "rBr", "GRG", 'C',
				Blocks.hardened_clay, 'H', Blocks.hopper, 'r', "dustRedstone", 'R', "blockRedstone", 'G', "gearStone", 'B',
				new ItemStack(PeatizedBlocks.compressor, 1, 0)));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(PeatizedBlocks.compressor, 1, 2), "CHC", "rFr", "GBG", 'C',
				"cobblestone", 'H', Blocks.hopper, 'r', "dustRedstone", 'G', "gearStone", 'F', Blocks.furnace, 'B',
				new ItemStack(PeatizedBlocks.compressor, 1, 0)));
