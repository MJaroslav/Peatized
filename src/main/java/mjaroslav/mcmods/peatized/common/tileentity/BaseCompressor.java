...
public class BaseCompressor {
    ...
    public void readFromNBT(NBTTagCompound nbt) {
        NBTTagList nbttaglist = nbt.getTagList(NBTInfo.COMPRESSOR_ITEMS, 10);
        ...
        this.currentActivations = nbt.getInteger(NBTInfo.COMPRESSOR_CURRENT_ACTIVATIONS);
        this.activations = nbt.getInteger(NBTInfo.COMPRESSOR_ACTIVATIONS);
    }

    public boolean isWorking() {
        return this.currentActivations > 0;
    }
    ...
    public void writeToNBT(NBTTagCompound nbt) {
        ...
        nbt.setTag(NBTInfo.COMPRESSOR_ITEMS, nbttaglist);
        nbt.setInteger(NBTInfo.COMPRESSOR_ACTIVATIONS, this.activations);
        nbt.setInteger(NBTInfo.COMPRESSOR_CURRENT_ACTIVATIONS, this.currentActivations);
    }
